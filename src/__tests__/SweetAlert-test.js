...
describe("propTypes", () => {
  it("should return error when imageSize invalid", () => {
    expect(
      SweetAlert.propTypes.imageSize({ imageSize: "8080" }, "imageSize")
    ).toBeInstanceOf(Error);
  });

  it("should not return error when imageSize valid", () => {
    expect(
      SweetAlert.propTypes.imageSize({ imageSize: "80x80" }, "imageSize")
...
describe("`onConfirm`", () => {
  xit("should  works", () => {
    ...
    mount(<SweetAlert title="t" show onConfirm={callback} />);
  });
});
